...
v = VideoReader("C:\Users\Khrisna Adi Kamarga\Desktop\RoboticEyes\EyeMovement.mp4")
video = double(read(v));
...
for i = 1:t
    bwVideo = video(:,:,1,i);
    pcolor(flipud(bwVideo)), shading interp, colormap(gray);
    drawnow
end
...
close all; clc;
% 2D gaussian filter
tau = 100000; % bandwith of the filter (good: 0.2) 100 for normal
